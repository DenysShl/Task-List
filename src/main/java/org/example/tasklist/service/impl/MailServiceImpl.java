...
public class MailServiceImpl implements MailService {
    ...
    @Override
    public void sendEmail(User user, MailType type, Properties props) {
        switch (type) {
            case REGISTRATION -> sendRegistrationEmail(user, props);
            case REMINDER -> sendReminderEmail(user, props);
            default -> {
            }
        }
    }
